...
/***ja @defgroup m17nDatabase 言語情報データベース */
/*=*/
...
struct MInputContext
{
  ...
  /***en The usage of the following members depends on the input
      ...
      <im>->driver.filter ().  */
  /***ja 以下のメンバの使用法は入力ドライバによって異なる。以下の説明
